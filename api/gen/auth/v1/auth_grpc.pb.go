...
const (
	...
	AuthService_ForgotPassword_FullMethodName = "/api.auth.v1.AuthService/ForgotPassword"
	...
	AuthService_ListSessions_FullMethodName   = "/api.auth.v1.AuthService/ListSessions"
	AuthService_RevokeSession_FullMethodName  = "/api.auth.v1.AuthService/RevokeSession"
)
...
func (c *authServiceClient) RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*TokenSet, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenSet)
...
func (UnimplementedAuthServiceServer) RefreshToken(context.Context, *RefreshTokenRequest) (*TokenSet, error) {
