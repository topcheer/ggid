...
*Round 22 is even: execute E2E regression tests (`deploy/e2e-docker-test.sh`).*
...
- (current): Round 21 focus B route wiring — add missing gateway prefixes /api/v1/org, /api/v1/policy, /api/v1/webauthn
