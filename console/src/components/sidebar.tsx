      ...
      <aside className={`${mobileOpen ? "flex" : "hidden"} md:flex flex-col border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900`} style={{ width: "260px" }}>
        ...
        <div className="border-t border-gray-200 p-3 dark:border-gray-800">
          ...
          <div className="flex items-center gap-3 pt-2 border-t border-gray-100 dark:border-gray-800">
            <Link href="/profile" className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-200 text-sm font-medium hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">
            ...
            <div className="flex-1 min-w-0">
              <Link href="/profile" className="block truncate text-sm font-medium text-gray-900 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-200 dark:hover:text-blue-400">
            ...
            <button onClick={() => {
              // Clear ALL auth-related localStorage items to prevent stale state
              ["ggid_access_token","ggid_refresh_token","ggid_session_id","ggid_tenant_id","ggid_user_id","ggid_user_name","ggid_user_email","ggid_user_scopes","ggid_user_permissions","ggid_redirect_after_login"].forEach(k => localStorage.removeItem(k));
