...
export default function HelpPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "kb" && (
        <div>
          <div className="mb-4"><div className="relative max-w-md"><Search className="absolute left-3 top-2.5 h-4 w-4 text-gray-400" /><input type="text" aria-label="Search help articles" value={search} onChange={e => setSearch(e.target.value)} placeholder={t("help.searchArticles")} className="w-full rounded-lg border dark:border-gray-700 dark:bg-gray-900 pl-9 pr-3 py-2 text-sm" /></div></div>
