...
export default function DataLineagePage() {
  ...
  const fetchLineage = useCallback(async (resource: string) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`/api/v1/audit/data-lineage?resource=${encodeURIComponent(resource)}`, { headers: { "X-Tenant-ID": "00000000-0000-0000-0000-000000000001" } });
      if (res.ok) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold flex items-center gap-2"><GitBranch className="w-6 h-6 text-purple-500" /> Data Lineage</h1>
