    ...
    <div className="space-y-6">
      ...
      {tab === "security" && (
        <div className="space-y-6">
          ...
          <button onClick={saveConfig} disabled={saving} className="flex items-center gap-2 rounded-lg bg-gray-700 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500">{saving ? <Loader2 className="h-4 w-4 animate-spin" /> : <Save className="h-4 w-4" />} {t("adminSettings.save")}</button>
        </div>
      )}
        ...
        <div className="space-y-6">
          <div className={card}>
            ...
            {draining ? (
              ...
              <button onClick={triggerDrain} className="flex items-center gap-2 rounded-lg bg-yellow-600 px-4 py-2 text-sm font-medium text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-blue-500"><Power className="h-4 w-4" /> {t("adminSettings.triggerDrain")}</button>
            )}
          </div>
          <div className={card}>
