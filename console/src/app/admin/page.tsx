    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">{LINKS.map(l => { const Icon = l.icon; return (
          <a key={l.href} href={l.href} aria-label={l.label} className="group rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition hover:shadow-md hover:border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:hover:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
