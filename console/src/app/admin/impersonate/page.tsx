        ...
        <div className="mb-6 overflow-hidden rounded-xl border-2 border-yellow-400 bg-gradient-to-r from-yellow-50 to-amber-50 dark:border-yellow-600 dark:from-yellow-950 dark:to-amber-950">
          <div className="flex flex-col gap-3 p-4 sm:flex-row sm:items-center">
            ...
            <button
              ...
              disabled={submitting}
              className="flex items-center justify-center gap-2 rounded-lg bg-red-600 px-5 py-2.5 text-sm font-bold text-white shadow-sm transition-colors hover:bg-red-700 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              {submitting ? (
        ...
        <div>
              ...
              <div className="relative">
                ...
                {searchQuery && (
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <X className="h-4 w-4" />
                  </button>
                )}
                      ...
                      {(Array.isArray(searchResults) ? searchResults : []).map((user: any) => (
                        <li key={user.id}>
                          <button
                            ...
                            className="flex w-full items-center gap-3 px-4 py-2.5 text-left hover:bg-gray-50 dark:hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-blue-500"
                          >
              ...
              <div className="mt-4 rounded-xl border-2 border-brand-300 bg-brand-50 p-5 dark:border-brand-700 dark:bg-brand-900/20">
                <div className="mb-4 flex items-start gap-3">
                  ...
                  <button
                    ...
                    className="rounded-lg p-1 text-gray-400 hover:bg-gray-200 hover:text-red-500 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-brand-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-brand-700 disabled:cursor-not-allowed disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
             aria-label="User">
              {submitting ? (
                "Starting..."
              ) : (
          ...
          <div className={cardCls}>
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                ...
                className="text-xs text-brand-600 hover:underline disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
               aria-label="Action">
