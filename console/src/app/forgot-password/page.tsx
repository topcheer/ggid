    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-950">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold dark:text-gray-100">{t("forgotPassword.title")}</h1>
        </div>
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">{t("forgotPassword.instructions")}</p>
            <div className="mb-6">
