...
export default function OAuthErrorCatalogConfigPage() {
  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl">
      ...
      <div className="bg-white rounded-lg p-6 shadow"><div className="flex items-center gap-3"><input type="checkbox" checked={form.troubleshooting_enabled} onChange={(e) => setForm({ ...form, troubleshooting_enabled: e.target.checked })} className="w-4 h-4" /><label>Enable Troubleshooting Mode</label></div></div>
