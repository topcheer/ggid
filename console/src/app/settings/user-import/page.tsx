...
export default function UserImportPage() {
  ...
  const updateMapping = (i: number, field: string, value: string) => setMappings(mappings.map((m: any, idx: number) => idx === i ? { ...m, [field]: value } : m));
