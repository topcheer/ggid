...
import { useHealthCheckDesignConfig, HealthCheckDesignConfig, DependencyCheck, DegradationRule } from "@ggid/sdk-react";
...
export default function HealthCheckDesignConfigPage() {
  ...
  const [form, setForm] = useState<HealthCheckDesignConfig | null>(null);
