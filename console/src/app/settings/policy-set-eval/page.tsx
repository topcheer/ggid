...
export default function PolicySetEvalPage() {
  ...
  const evaluate = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("/api/v1/policy/set-evaluate", { method: "POST", headers: { "Content-Type": "application/json", "X-Tenant-ID": "00000000-0000-0000-0000-000000000001" }, body: JSON.stringify({ subject, resource, action: action || "access" }) });
