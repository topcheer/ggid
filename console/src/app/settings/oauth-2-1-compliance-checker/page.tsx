...
import { useOAuth21ComplianceChecker, OAuth21ComplianceChecker, ComplianceCheckItem, NonCompliantClient, RemediationAction } from "@ggid/sdk-react";

export default function OAuth21ComplianceCheckerPage() {
  const { config, loading, error, fetchConfig } = useOAuth21ComplianceChecker();
  const [form, setForm] = useState<OAuth21ComplianceChecker | null>(null);
