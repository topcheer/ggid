...
export default function IdentityRecoveryConfigPage() {
  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl">
      ...
      <button onClick={handleSave} disabled={saving} className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50">{saving ? t("big1.identityRecoveryConfig.saving") : t("big1.identityRecoveryConfig.saveChanges")}</button>
    </div>
  );
}
