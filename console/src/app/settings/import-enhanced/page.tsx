    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className={card}>
        ...
        <div className="space-y-4">
          <div>
            <label className="block w-full cursor-pointer rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 p-8 text-center transition hover:border-blue-500 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
              <input
                type="file"
                accept=".csv,.json"
                className="hidden"
