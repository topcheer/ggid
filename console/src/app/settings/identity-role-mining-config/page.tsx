...
export default function IdentityRoleMiningConfigPage() {
  ...
  if (loading) return <div className="p-8 text-gray-400">Loading role mining config...</div>;
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold">Role Mining Configuration</h1>
          <p className="text-sm text-gray-400 mt-1">Discover optimal role structures from access patterns</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-900 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-1 text-blue-400">
            ...
            <span className="text-xs text-gray-400">Min Usage Threshold</span>
          </div>
        ...
        <div className="bg-gray-900 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-1 text-purple-400">
            ...
            <span className="text-xs text-gray-400">Co-occurrence Window</span>
          </div>
        ...
        <div className="bg-gray-900 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-1 text-yellow-400">
            ...
            <span className="text-xs text-gray-400">Applied Roles</span>
          </div>
      ...
      <div className="bg-gray-900 rounded-xl p-4 mb-6">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-4">
            <div>
              <span className="text-xs text-gray-400 block">Similarity Algorithm</span>
              <span className="text-sm font-medium capitalize">{data?.similarity_algorithm}</span>
            </div>
            <div>
              <span className="text-xs text-gray-400 block">Auto-Suggest Roles</span>
            ...
            <div>
              <span className="text-xs text-gray-400 block">Last Mining Run</span>
      ...
      <div className="bg-gray-900 rounded-xl p-6">
        ...
        <div className="space-y-2">
            ...
            <div key={i} className="bg-gray-800 rounded-lg p-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="text-xs px-2 py-1 bg-green-600 hover:bg-green-700 rounded">Accept</button>
                  <button className="text-xs px-2 py-1 bg-gray-600 hover:bg-gray-500 rounded">Reject</button>
                </div>
              </div>
          ...
          {(data?.suggested_roles_review_queue ?? []).length === 0 && (
            <p className="text-sm text-gray-500 text-center py-4">No suggested roles to review.</p>
          )}
        </div>
      </div>
    </div>
