  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="flex items-center gap-2 text-2xl font-bold text-gray-900 dark:text-white"><Users2 className="h-6 w-6 text-purple-600" /> Dynamic Roles</h1>
            ...
            <div key={r.id} className={cardCls}>
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex flex-wrap gap-1">{r.conditions.map((c, i) => <span key={i} className="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-xs text-gray-600 dark:bg-gray-700 dark:text-gray-300">{c.attribute} {c.operator} {c.value}</span>)}{r.conditions.length === 0 && <span className="text-xs text-gray-400">No conditions</span>}</div>
                </div>
      ...
      <div className={cardCls}>
        <h3 className="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300">Test Dynamic Role Assignment</h3>
