  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border dark:border-gray-800 p-4 space-y-3">
        ...
        <button aria-label="Play" onClick={exchange} disabled={loading || !subjectToken} className="px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-medium disabled:opacity-50 flex items-center gap-2"><Play className="w-4 h-4" /> {loading ? "Exchanging..." : "Exchange Token"}</button>
      </div>
