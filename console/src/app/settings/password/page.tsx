  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        {/* ── Complexity Rules ── */}
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <h2 className="mb-2 text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300">Complexity Rules</h2>
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <h2 className="mb-2 flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300">
          ...
          {config.prevent_common && (
            <div className="mt-4 flex items-center justify-between rounded-lg bg-gray-50 dark:bg-gray-800 p-3 dark:bg-gray-900">
              ...
              <button
                ...
                className="rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-1.5 text-xs font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800"
              >
                View List
              </button>
            </div>
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 pr-10 text-sm focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
            />
            <button
              type="button"
          ...
          {/* Rule checks */}
          {testPw && (
            <div className="mt-4 space-y-0.5 rounded-lg bg-gray-50 dark:bg-gray-800 p-3 dark:bg-gray-900">
              ...
              <div className="mt-2 border-t border-gray-200 dark:border-gray-700 pt-2 dark:border-gray-700">
                {allRulesPass ? (
        ...
        <div className="flex justify-between">
          <button
            onClick={handleReset}
            className="flex items-center gap-1.5 rounded-lg border border-gray-300 dark:border-gray-600 px-5 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800"
          >
      ...
      {showBlacklist && (
        ...
        >
          <div
            className="max-h-[70vh] w-full max-w-lg overflow-hidden rounded-xl bg-white dark:bg-gray-800 shadow-2xl dark:bg-gray-800"
          ...
          >
            <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 p-4 dark:border-gray-700">
              ...
              <button onClick={() => setShowBlacklist(false)} aria-label="Close" className="text-gray-400 hover:text-gray-600 dark:text-gray-400">
                <X className="h-5 w-5" />
              </button>
            </div>
            <div className="p-4">
              ...
              <div className="grid max-h-50 grid-cols-2 gap-1 overflow-y-auto sm:grid-cols-3" style={{ maxHeight: "300px" }}>
                {COMMON_PASSWORDS.map((pw: any) => (
                  <code
                    key={pw}
                    className="rounded bg-gray-100 dark:bg-gray-700 px-2 py-1 text-xs text-gray-600 dark:text-gray-400 dark:bg-gray-900 dark:text-gray-400"
                  >
                    {pw}
                  </code>
                ))}
