...
export default function IdentityDeprovisioningAutomationPage() {
  ...
  if (loading) return <div className="p-8 text-gray-400">Loading deprovisioning automation...</div>;
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold">Deprovisioning Automation</h1>
          <p className="text-sm text-gray-400 mt-1">Automated user deprovisioning triggered by HR events, policies, or manual requests</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-900 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-1 text-blue-400">
            ...
            <span className="text-xs text-gray-400">Automation Rules</span>
          </div>
        ...
        <div className="bg-gray-900 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-1 text-purple-400">
            ...
            <span className="text-xs text-gray-400">Processed (7d)</span>
          </div>
              ...
              <div key={i} className="bg-gray-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Action: {rule.action} - Delay: {rule.delay_hours}h</p>
                  </div>
                  <span
          ...
          <div className="space-y-2 max-h-64 overflow-y-auto">
            {(data?.pending_actions ?? []).map((action, i) => (
              <div key={i} className="bg-gray-800 rounded-lg p-3">
                ...
                <p className="text-xs text-gray-400">Trigger: {action.trigger_reason}</p>
                <p className="text-xs text-gray-500">Scheduled: {action.scheduled_at}</p>
              </div>
            ))}
      ...
      <div className="bg-gray-900 rounded-xl p-6 mt-6">
        <h2 className="text-lg font-semibold mb-4">Deprovisioning Workflow</h2>
