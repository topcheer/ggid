  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="rounded-lg border p-4 dark:border-gray-800"><span className="text-sm text-gray-500">{t("backend3.attributeGovernance.masked")}</span><p className="text-xl font-bold text-green-600 mt-1">{attrs.filter((a) => a.mask_rule !== "none").length}</p></div>
      </div>
