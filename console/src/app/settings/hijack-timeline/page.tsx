  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <button aria-label="action" onClick={fetchTimeline} disabled={loading || !search} className="px-4 py-2 rounded-lg bg-red-600 text-white text-sm font-medium hover:bg-red-700 disabled:opacity-50">{t("big1.hijackTimeline.analyze")}</button>
      </div>
        ...
        <>
          ...
          <div className="relative pl-8">
            ...
            <div className="space-y-2">
              {data.events.map((evt: any) => { const Icon = eventIcons[evt.event_type] || AlertTriangle; return (
