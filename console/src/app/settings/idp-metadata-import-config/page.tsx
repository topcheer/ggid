  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      ...
      <div className="bg-gray-900 rounded-xl p-6 mb-6">
        ...
        {tab === t("big1.idpMetadataImportConfig.xml") && <textarea aria-label="<EntityDescriptor..." value={xmlInput} onChange={(e) => setXmlInput(e.target.value)} placeholder="<EntityDescriptor..." rows={6} className="w-full px-3 py-2 bg-gray-800 rounded-lg text-sm font-mono" />}
