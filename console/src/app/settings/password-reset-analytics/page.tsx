...
export default function PasswordResetAnalyticsPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`/api/v1/auth/password-reset-analytics?start=${startDate}&end=${endDate}`, { headers: { ...authHeader(), "X-Tenant-ID": "00000000-0000-0000-0000-000000000001" } });
