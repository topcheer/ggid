  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl">
      ...
      <div className="bg-white rounded-lg p-6 shadow space-y-4">
        ...
        <div><label className="block text-sm font-medium mb-1">Materialized View Refresh (s)</label><input aria-label="form" type="number" value={form.materialized_view_refresh_interval} onChange={(e) => setForm({ ...form, materialized_view_refresh_interval: parseInt(e.target.value) || 0 })} className="border rounded px-3 py-2 w-32" /></div>
      </div>
