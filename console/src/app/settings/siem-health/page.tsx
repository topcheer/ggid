...
export default function SIEMHealthPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const res = await fetch("/api/v1/audit/siem-health", { headers: { "X-Tenant-ID": "00000000-0000-0000-0000-000000000001" } });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold flex items-center gap-2"><Activity className="w-6 h-6 text-blue-500" /> SIEM Health Check</h1>
        <p className="text-sm text-gray-500 mt-1">Monitor SIEM forwarding destinations connectivity and throughput.</p>
      </div>
