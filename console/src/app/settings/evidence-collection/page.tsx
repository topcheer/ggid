...
export default function EvidenceCollectionPage() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-2xl font-bold flex items-center gap-2"><FolderCheck className="w-6 h-6 text-blue-500" /> Evidence Collection</h1><p className="text-sm text-gray-500 mt-1">Track compliance evidence collection per control.</p></div>
