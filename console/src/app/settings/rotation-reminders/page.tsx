...
export default function RotationRemindersPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const res = await fetch("/api/v1/auth/rotation-reminders", { headers: { "X-Tenant-ID": "00000000-0000-0000-0000-000000000001" } });
  ...
  const sendReminder = async (id: string) => {
    setSendingId(id);
    try { await fetch(`/api/v1/auth/rotation-reminders/${id}/send`, { method: "POST", headers: { "X-Tenant-ID": "00000000-0000-0000-0000-000000000001" } }); }
    catch { /* noop */ }
