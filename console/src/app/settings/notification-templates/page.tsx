...
export default function NotificationTemplatesPage() {
  ...
  return (
    <div className="p-8 space-y-6 max-w-5xl">
      ...
      <div className="bg-white rounded-lg p-6 shadow"><h2 className="text-lg font-semibold mb-2">Available Variables</h2><div className="flex flex-wrap gap-2">{Object.keys(previewData).map((v: any) => <span key={v} className="px-2 py-1 bg-gray-100 rounded text-xs font-mono">{'{{'}{v}{'}}'}</span>)}</div></div>
    </div>
  );
}
