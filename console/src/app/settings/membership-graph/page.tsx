...
export default function MembershipGraphPage() {
  ...
  const fetchGraph = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`/api/v1/identity/membership-graph?group_id=${encodeURIComponent(groupId)}`, { headers: { ...authHeader(), "X-Tenant-ID": "00000000-0000-0000-0000-000000000001" } });
