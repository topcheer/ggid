...
export default function AccessRequestLifecycleConfigPage() {
  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl">
      <h1 className="text-2xl font-bold">Access Request Lifecycle Configuration</h1>
      <p className="text-gray-600">Configure access request stages, SLAs, and auto-approval rules.</p>

      <div className="bg-white rounded-lg p-6 shadow">
        <h2 className="text-lg font-semibold mb-4">Lifecycle Stages</h2>
      ...
      <div className="bg-white rounded-lg p-6 shadow space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div><label className="block text-sm font-medium mb-1">Max Duration (days)</label><input type="number" value={form.max_duration_days} onChange={(e) => setForm({ ...form, max_duration_days: parseInt(e.target.value) || 0 })} className="border rounded px-3 py-2 w-full" /></div>
      ...
      <div className="bg-white rounded-lg p-6 shadow">
        ...
        <table className="w-full text-sm"><thead><tr className="border-b text-left"><th className="py-2">Condition</th><th>Target Role</th><th>Max Duration</th></tr></thead><tbody>
