  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex justify-end gap-3">
        <button aria-label="action" className="px-4 py-2 border rounded text-sm">{"Rollback"}</button>
        <button aria-label="action" className="px-4 py-2 bg-blue-600 text-white rounded text-sm">{"Promote"}</button>
      </div>
    </div>
  );
}
