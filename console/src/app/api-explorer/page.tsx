...
const API_SPEC: Endpoint[] = [
  ...
  { method: "POST", path: "/api/v1/webauthn/register/begin", summary: "Begin WebAuthn registration", tags: ["Auth"] },
  { method: "POST", path: "/api/v1/webauthn/register/finish", summary: "Finish WebAuthn registration", tags: ["Auth"] },
