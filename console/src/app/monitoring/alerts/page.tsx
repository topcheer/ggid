        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setShowSilenceForm(false)}>
          <div role="dialog" aria-modal="true" className="mx-4 w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-gray-800" onClick={e => e.stopPropagation()}>
            ...
            <div className="mt-4 space-y-3">
              <div><label className="text-sm font-medium">{t("alerts.reason")}</label><input type="text" aria-label="Silence reason" value={silenceReason} onChange={e => setSilenceReason(e.target.value)} placeholder="Maintenance window" className="mt-1 w-full rounded-lg border dark:border-gray-700 dark:bg-gray-900 px-3 py-2 text-sm" autoFocus /></div>
