...
<p style="color: #4a4a4a; font-size: 16px; line-height: 1.5;">Hi ` + d.UserName + `,</p>
<p style="color: #4a4a4a; font-size: 16px; line-height: 1.5;">
We received a request to reset your password. Click the button below to set a new password:
</p>
<p style="text-align: center; margin: 30px 0;">
<a href="` + d.Link + `" style="background-color: #4F46E5; color: white; padding: 12px 32px; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: bold;">Reset Password</a>
</p>
...
<p style="color: #4a4a4a; font-size: 16px;">Hi ` + d.UserName + `,</p>
<p style="color: #4a4a4a; font-size: 16px;">Please verify your email address by clicking the button below:</p>
<p style="text-align: center; margin: 30px 0;">
<a href="` + d.Link + `" style="background-color: #10B981; color: white; padding: 12px 32px; text-decoration: none; border-radius: 6px; font-weight: bold;">Verify Email</a>
</p>
<hr style="border: none; border-top: 1px solid #e5e7eb; margin: 30px 0;">
...
func WelcomeHTML(d WelcomeData) string {
	...
	return `<html><body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
<h2 style="color: #1a1a1a;">Welcome to ` + appName + `!</h2>
<p style="color: #4a4a4a; font-size: 16px;">Hi ` + d.UserName + `,</p>
<p style="color: #4a4a4a; font-size: 16px;">Your account has been created successfully. Welcome aboard!</p>
<p style="text-align: center; margin: 30px 0;">
<a href="` + d.Link + `" style="background-color: #4F46E5; color: white; padding: 12px 32px; text-decoration: none; border-radius: 6px; font-weight: bold;">Get Started</a>
</p>
<hr style="border: none; border-top: 1px solid #e5e7eb; margin: 30px 0;">
<p style="color: #9ca3af; font-size: 12px;">This is an automated message from ` + appName + `.</p>
</body></html>`
...
<p style="text-align: center; margin: 30px 0;">
<span style="font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #4F46E5;">` + d.Code + `</span>
</p>
