...
func (s *HTTPServer) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/api/v1/policies/access-frequency", s.handleAccessFrequency)
	mux.HandleFunc("/api/v1/policies/privileged-access", s.handlePrivilegedAccess)
	...
	mux.HandleFunc("/api/v1/policies/conditional-access/evaluate", s.handleConditionalAccessEvaluate)
	...
	mux.HandleFunc("/api/v1/policies/role-requests/", s.handleRoleRequests)
	mux.HandleFunc("/api/v1/policies/simulate", s.handlePolicySimulate)
	...
	// Top-level route aliases (without /policies/ prefix)
	...
	mux.HandleFunc("/api/v1/policies/access-reviews/delegate", s.handleReviewDelegation)
	mux.HandleFunc("/api/v1/policies/access-reviews/delegated", s.handleReviewDelegation)
	mux.HandleFunc("/api/v1/policies/access-reviews/escalate", s.handleReviewEscalation)
	mux.HandleFunc("/api/v1/policies/access-reviews/escalated", s.handleReviewEscalation)
	mux.HandleFunc("/api/v1/policy/conflicts", s.handlePolicyConflictsDetect)
	mux.HandleFunc("/api/v1/policy/access-certification/campaigns", s.handleAccessCertificationCampaigns)
	mux.HandleFunc("/api/v1/policy/access-request/", s.handleAccessRequestCRUD)
	mux.HandleFunc("/api/v1/policy/as-code/import", s.handlePolicyAsCodeImport)
	mux.HandleFunc("/api/v1/policy/auto-assignment/campaigns", s.handleAutoAssignmentCampaigns)
	mux.HandleFunc("/api/v1/policy/privileged-access/batch-revoke", s.handlePrivilegedAccessBatchRevoke)
	mux.HandleFunc("/api/v1/policy/recommendations/", s.handlePolicyRecommendations)
	mux.HandleFunc("/api/v1/policy/risk-score/summary", s.handleRiskScoreSummary)
	mux.HandleFunc("/api/v1/policy/risk-score/users", s.handleRiskScoreUsers)
	mux.HandleFunc("/api/v1/policy/risk-score/recalculate", s.handleRiskScoreRecalculate)
	mux.HandleFunc("/api/v1/policy/role-mining/analysis", s.handleRoleMiningAnalysis)
	mux.HandleFunc("/api/v1/policy/role-mining/apply", s.handleRoleMiningApply)
	mux.HandleFunc("/api/v1/policy/roles/hierarchy", s.handleRolesHierarchy)
	mux.HandleFunc("/api/v1/policy/roles/inheritance", s.handleRolesInheritance)
	mux.HandleFunc("/api/v1/policy/sod-matrix/toggle", s.handleSoDMatrixToggle)
	mux.HandleFunc("/api/v1/policy/sod/violations/summary", s.handleSoDViolationsSummary)
	mux.HandleFunc("/api/v1/policy/time-based/rules", s.handleTimeBasedRules)
	...
	mux.HandleFunc("/api/v1/policy/import-export", s.handlePolicyImportExport)
	mux.HandleFunc("/api/v1/policy/stats/decision-log", s.handleDecisionLogStats)
	mux.HandleFunc("/api/v1/policy/feature-flags", s.handleFeatureFlags)
	...
	mux.HandleFunc("/api/v1/policy/policies/", s.handlePolicyVersionRoute)
