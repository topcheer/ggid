...
func (h *Handler) registerRoutes() {
	...
	h.mux.HandleFunc("/api/v1/auth/dlp/policies", h.handleDLPPoliciesCRUD)
	h.mux.HandleFunc("/api/v1/auth/dlp/policies/", h.handleDLPPoliciesCRUD)
	h.mux.HandleFunc("/api/v1/dlp/policies", h.handleDLPPoliciesCRUD)
	h.mux.HandleFunc("/api/v1/dlp/policies/", h.handleDLPPoliciesCRUD)
	...
	h.mux.HandleFunc("/api/v1/notification/preferences", h.handleNotificationPreferences) // alias for Console
