...
func Default() *Config {
	...
	return &Config{
		...
		Routes: map[string]string{
			...
			"/api/v1/departments":  envOrDefault("ORG_SERVICE_URL", "http://localhost:8071"),
			...
			"/api/v1/admin/audit":     envOrDefault("AUDIT_SERVICE_URL", "http://localhost:8072"),
			"/api/v1/admin/threats":   envOrDefault("AUDIT_SERVICE_URL", "http://localhost:8072"),
			...
			"/api/v1/self-service":    envOrDefault("AUTH_SERVICE_URL", "http://localhost:9001"),
