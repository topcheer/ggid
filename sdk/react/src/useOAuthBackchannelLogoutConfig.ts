  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setData({
        ...
        client_configs: [
          { client_id: "client-web-001", client_name: "Web Dashboard", backchannel_logout_enabled: true },
          { client_id: "client-mobile-002", client_name: "Mobile App", backchannel_logout_enabled: true },
          { client_id: "client-api-003", client_name: "API Gateway", backchannel_logout_enabled: false },
          { client_id: "client-spa-004", client_name: "Marketing SPA", backchannel_logout_enabled: true },
        ],
